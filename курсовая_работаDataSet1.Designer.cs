...
namespace курсовая_работа_Дзякун {
    ...
    public partial class курсовая_работаDataSet1 : global::System.Data.DataSet {
        ...
        public partial class СотрудникиDataTable : global::System.Data.TypedTableBase<СотрудникиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public СотрудникиRow AddСотрудникиRow(int id_сотрудника, string Фамилия, string Имя, string Отчество, string Фото) {
...
namespace курсовая_работа_Дзякун.курсовая_работаDataSet1TableAdapters {
    ...
    public partial class СотрудникиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Сотрудники] WHERE (([id_сотрудника] = @Original_id_сотрудника) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ((@IsNull_Фото = 1 AND [Фото] IS NULL) OR ([Фото] = @Original_Фото)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Сотрудники] ([id_сотрудника], [Фамилия], [Имя], [Отчество], [Ф" +
                "ото]) VALUES (@id_сотрудника, @Фамилия, @Имя, @Отчество, @Фото);\r\nSELECT id_сотр" +
                "удника, Фамилия, Имя, Отчество, Фото FROM Сотрудники WHERE (id_сотрудника = @id_" +
                "сотрудника)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Сотрудники] SET [id_сотрудника] = @id_сотрудника, [Фамилия] = @Фамилия, [Имя] = @Имя, [Отчество] = @Отчество, [Фото] = @Фото WHERE (([id_сотрудника] = @Original_id_сотрудника) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ((@IsNull_Фото = 1 AND [Фото] IS NULL) OR ([Фото] = @Original_Фото)));
SELECT id_сотрудника, Фамилия, Имя, Отчество, Фото FROM Сотрудники WHERE (id_сотрудника = @id_сотрудника)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::курсовая_работа_Дзякун.Properties.Settings.Default.курсовая_работаConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_сотрудника, Фамилия, Имя, Отчество, Фото FROM dbo.Сотрудники";
        ...
        public virtual int Fill(курсовая_работаDataSet1.СотрудникиDataTable dataTable) {
        ...
        public virtual курсовая_работаDataSet1.СотрудникиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            курсовая_работаDataSet1.СотрудникиDataTable dataTable = new курсовая_работаDataSet1.СотрудникиDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(курсовая_работаDataSet1.СотрудникиDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id_сотрудника, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Фото) {
        ...
        public virtual int Insert(int id_сотрудника, string Фамилия, string Имя, string Отчество, string Фото) {
        ...
        public virtual int Update(int id_сотрудника, string Фамилия, string Имя, string Отчество, string Фото, int Original_id_сотрудника, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Фото) {
            ...
            if ((Original_Фото == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_Фото));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Фамилия, string Имя, string Отчество, string Фото, int Original_id_сотрудника, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Фото) {
            return this.Update(Original_id_сотрудника, Фамилия, Имя, Отчество, Фото, Original_id_сотрудника, Original_Фамилия, Original_Имя, Original_Отчество, Original_Фото);
        }
    }
