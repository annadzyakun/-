...
namespace курсовая_работа_Дзякун {
    ...
    public partial class курсовая_работаDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/курсовая_работаDataSet3.xsd";
        ...
        public partial class СотрудникDataTable : global::System.Data.TypedTableBase<СотрудникRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public СотрудникRow AddСотрудникRow(string Фамилия, string Имя, string Отчество, byte[] Фото) {
...
namespace курсовая_работа_Дзякун.курсовая_работаDataSetTableAdapters {
    ...
    public partial class СотрудникTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Сотрудник] ([Фамилия], [Имя], [Отчество], [Фото]) VALUES (@Фам" +
                "илия, @Имя, @Отчество, @Фото);\r\nSELECT id_сотрудника, Фамилия, Имя, Отчество, Фо" +
                "то FROM Сотрудник WHERE (id_сотрудника = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Сотрудник] SET [Фамилия] = @Фамилия, [Имя] = @Имя, [Отчество] = @Отчество, [Фото] = @Фото WHERE (([id_сотрудника] = @Original_id_сотрудника) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)));
SELECT id_сотрудника, Фамилия, Имя, Отчество, Фото FROM Сотрудник WHERE (id_сотрудника = @id_сотрудника)";
        ...
        public virtual int Fill(курсовая_работаDataSet.СотрудникDataTable dataTable) {
        ...
        public virtual курсовая_работаDataSet.СотрудникDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            курсовая_работаDataSet.СотрудникDataTable dataTable = new курсовая_работаDataSet.СотрудникDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(курсовая_работаDataSet.СотрудникDataTable dataTable) {
        ...
        public virtual int Insert(string Фамилия, string Имя, string Отчество, byte[] Фото) {
            if ((Фамилия == null)) {
        ...
        public virtual int Update(string Фамилия, string Имя, string Отчество, byte[] Фото, int Original_id_сотрудника, string Original_Фамилия, string Original_Имя, string Original_Отчество, int id_сотрудника) {
            if ((Фамилия == null)) {
        ...
        public virtual int Update(string Фамилия, string Имя, string Отчество, byte[] Фото, int Original_id_сотрудника, string Original_Фамилия, string Original_Имя, string Original_Отчество) {
            return this.Update(Фамилия, Имя, Отчество, Фото, Original_id_сотрудника, Original_Фамилия, Original_Имя, Original_Отчество, Original_id_сотрудника);
        }
    }
