...
namespace курсовая_работа_Дзякун.курсовая_работаDataSetTableAdapters {
...
SELECT id_сотрудника, Фамилия, Имя, Отчество, Фото FROM Сотрудники WHERE (id_сотрудника = @id_сотрудника)";
        ...
        public virtual int Fill(курсовая_работаDataSet.СотрудникиDataTable dataTable) {
        ...
        public virtual курсовая_работаDataSet.СотрудникиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            курсовая_работаDataSet.СотрудникиDataTable dataTable = new курсовая_работаDataSet.СотрудникиDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(курсовая_работаDataSet.СотрудникиDataTable dataTable) {
